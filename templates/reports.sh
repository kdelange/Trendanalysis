...
## Dragen data reports
#
chronqc plot -o "${CHRONQC_REPORTS_DIRS}/${TODAY}/" -p dragen -f "${CHRONQC_DATABASE_NAME}/chronqc_db/chronqc.stats.sqlite" dragenExoom "${CHRONQC_TEMPLATE_DIRS}/chronqc.dragenExoom.json"
