...
function copyQCRawdataToTmp() {
	...
	then
		...
		copyQCdataToTmp "${_rawdata}" "${_rawdata_job_controle_file_base}" "${_line_base}" "${_prm_rawdata_dir}/${_rawdata}/Info/SequenceRun/"* "${TMP_ROOT_DIR}/trendanalysis/rawdata/${_rawdata}/"
# 		
# 		
